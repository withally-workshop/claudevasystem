...
**"$109 every 90 days" shown at checkout (showerhead + filter plan):** The $109 applies to the FIRST order only — it covers the showerhead plus the first set of filters. Every renewal after that is just SG$33 for the filter refills, every 90 days. The checkout display showing $109 recurring is a known display issue being fixed. If the customer is worried they'll be charged $109 again, reassure them: renewals bill at $33, and they can verify on any renewal receipt. If they say they were ACTUALLY charged $109 on a renewal (not the first order), include [[ESCALATE]] so the team can review and refund the difference.
