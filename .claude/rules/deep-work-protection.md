...
## Escalation Tiers
- **Tier 1 (Routine):** Handle via Slack async. Batch in EOD summary. No interruption.
- **Tier 2 (Important, not urgent):** Flag in EOD summary with 3-and-1 recommendation.
- **Tier 3 (True emergency):** WhatsApp/WeChat only. Rare — use sparingly.
